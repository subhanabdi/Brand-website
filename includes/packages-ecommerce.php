                        ...
                        <div class="boxpackages">
                           ...
                           <div class="packdetails">
                              ...
                              <div class="botarea-pack">
                                 <div class="fleft">
                                    <a class="montfont btn-orders" href="package-detail?id=ecommerce1" title="">Order Now</a>
                                 </div>
                                 <div class="fright">
                     ...
                     <div class="col-md-4">
                        <div class="boxpackages">
                           <div class="packheads">
                              <h3 class="montfont">E-Commerce Start Up Package</h3>
                              <p>Value Added Design Solution</p>
                           </div>
                           <div class="packdetails">
                              <div class="packtitles">
                                 <div class="fleft">
                                    <h3 class="opensansfont">$699
                                       <sub class="">60% off</sub>
                                    </h3>
                                 </div>
                                 <div class="fright">
                                    <h4>WAS
                                       <b>
                                       <span class="cutprice">$1,699</span>
                                       </b>
                                    </h4>
                                 </div>
                              </div>
                              ...
                              <div class="botarea-pack">
                                 <div class="fleft">
                                    <a class="montfont btn-orders" href="package-detail?id=ecommerce2" title="">Order Now</a>
                                 </div>
                                 <div class="fright">
                                    <div class="liovechats-bx">
                                       <a href="javascript:;" title="" onclick="setButtonURL();">
                     ...
                     <div class="col-md-4">
                        <div class="boxpackages">
                           <div class="packheads">
                              <h3 class="montfont">E-Commerce Elite Package</h3>
                              <p>Value Added Design Solution</p>
                           </div>
                           <div class="packdetails">
                              <div class="packtitles">
                                 <div class="fleft">
                                    <h3 class="opensansfont">$1,699
                                       <sub class="">60% off</sub>
                                    </h3>
                                 </div>
                                 <div class="fright">
                                    <h4>WAS
                                       <b>
                                       <span class="cutprice">$3,399</span>
                                       </b>
                                    </h4>
                                 </div>
                              </div>
                              ...
                              <div class="botarea-pack">
                                 <div class="fleft">
                                    <a class="montfont btn-orders" href="package-detail?id=ecommerce3" title="">Order Now</a>
                                 </div>
                                 <div class="fright">
                                    <div class="liovechats-bx">
                                       <a href="javascript:;" title="" onclick="setButtonURL();">
                     ...
                     <div class="col-md-4">
                        <div class="boxpackages">
                           <div class="packheads">
                              <h3 class="montfont">E-Commerce Professional Package</h3>
                              <p>Value Added Design Solution</p>
                           </div>
                           <div class="packdetails">
                              <div class="packtitles">
                                 ...
                                 <div class="fright">
                                    <h4>WAS
                                       <b>
                                       <span class="cutprice">$2,399</span>
                                       </b>
                                    </h4>
                                 </div>
                              </div>
                              ...
                              <div class="botarea-pack">
                                 <div class="fleft">
                                    <a class="montfont btn-orders" href="package-detail?id=ecommerce4" title="">Order Now</a>
                                 </div>
                                 <div class="fright">
                                    <div class="liovechats-bx">
                                       <a href="javascript:;" title="" onclick="setButtonURL();">
                     ...
                     <div class="col-md-4">
                        <div class="boxpackages">
                           <div class="packheads">
                              <h3 class="montfont">E-Commerce Identity Package</h3>
                              <p>Value Added Design Solution</p>
                           </div>
                           <div class="packdetails">
                              <div class="packtitles">
                                 <div class="fleft">
                                    <h3 class="opensansfont">$2,499
                                       <sub class="">60% off</sub>
                                    </h3>
                                 </div>
                                 <div class="fright">
                                    <h4>WAS
                                       <b>
                                       <span class="cutprice">$4,999</span>
                                       </b>
                                    </h4>
                                 </div>
                              </div>
                              ...
                              <div class="botarea-pack">
                                 <div class="fleft">
                                    <a class="montfont btn-orders" href="package-detail?id=ecommerce5" title="">Order Now</a>
                                 </div>
                                 <div class="fright">
                                    <div class="liovechats-bx">
                                       <a href="javascript:;" title="" onclick="setButtonURL();">
                     ...
                     <div class="col-md-4">
                        <div class="boxpackages">
                           <div class="packheads">
                              <h3 class="montfont">E-Commerce Corporate Package</h3>
                              <p>Value Added Design Solution</p>
                           </div>
                           <div class="packdetails">
                              <div class="packtitles">
                                 <div class="fleft">
                                    <h3 class="opensansfont">$3,699
                                       <sub class="">60% off</sub>
                                    </h3>
                                 </div>
                                 <div class="fright">
                                    <h4>WAS
                                       <b>
                                       <span class="cutprice">$5,399</span>
                                       </b>
                                    </h4>
                                 </div>
                              </div>
                              ...
                              <div class="botarea-pack">
                                 <div class="fleft">
                                    <a class="montfont btn-orders" href="package-detail?id=ecommerce6" title="">Order Now</a>
                                 </div>
                                 <div class="fright">
                                    <div class="liovechats-bx">
                                       <a href="javascript:;" title="" onclick="setButtonURL();">
